...
qiime diversity beta-group-significance --i-distance-matrix ${results_folder}/s07_diversity_metrics/unweighted_unifrac_distance_matrix.qza  --m-metadata-file samples.txt --m-metadata-column Day --o-visualization $results_folder/unweighted-unifrac-donor-significance.qzv

qiime diversity beta-group-significance --i-distance-matrix ${results_folder}/s07_diversity_metrics/weighted_unifrac_distance_matrix.qza --m-metadata-file samples.txt --m-metadata-column Day --o-visualization $results_folder/weighted-unifrac-donor-significance.qzv
