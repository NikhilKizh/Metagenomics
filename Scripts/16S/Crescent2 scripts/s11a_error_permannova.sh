...
# qsub s11a_beta_group_permannova_Day1.sh

# PBS directives
#---------------

#PBS -N s11a_beta_group_permannova_Day1
...
# betagroup significance permannova day1 day28
...
qiime diversity beta-group-significance \
     ...
     --o-visualization $results_folder/s11a_unweighted-unifrac-Day1-significance.qzv

qiime diversity beta-group-significance \
     --i-distance-matrix ${results_folder}/s07_diversity_metrics/weighted_unifrac_distance_matrix.qza \
     --m-metadata-file samplesone.txt \
     --m-metadata-column Day \
     --o-visualization $results_folder/s11a_weighted-unifrac-Day1-significance.qzv

qiime diversity beta-group-significance \
     --i-distance-matrix ${results_folder}/s07_diversity_metrics/unweighted_unifrac_distance_matrix.qza \
     --m-metadata-file samplestwentyeight.txt \
     --m-metadata-column Day \
     --o-visualization $results_folder/s11a_unweighted-unifrac-Day28-significance.qzv

qiime diversity beta-group-significance \
     --i-distance-matrix ${results_folder}/s07_diversity_metrics/weighted_unifrac_distance_matrix.qza \
     --m-metadata-file samplestwentyeight.txt \
     --m-metadata-column Day \
     --o-visualization $results_folder/s11a_weighted-unifrac-Day28-significance.qzv
